...
#define ISSX_CONTRACTS_MODULE_VERSION            "1.7.2"
#define ISSX_CONTRACTS_STAGE_API_VERSION         "1.7.2"
#define ISSX_CONTRACTS_SERIALIZER_VERSION        "1.7.2"
#define ISSX_CONTRACTS_EXTERNAL_CONTRACT_VERSION "ea5_v1.7.2"
...
private:
   ...
   static string TruthTimeframeToCompact(ISSX_EA2_TimeframeTrust t){ return TimeframeModeToString(t.readiness)+"|"+FreshnessClassToString(t.freshness)+"|"+TruthClassToString(t.quality_class)+"|"+DoubleToString(t.continuity,4); }

   static int FindEa2BySymbol(ISSX_EA2_State ea2,const string symbol_norm,const string symbol_raw)
     {
   ...
   static double ComputeCompletenessScore(ISSX_EA1_SymbolState m,ISSX_EA2_SymbolState h,ISSX_EA3_SymbolSelection s,const bool has_intelligence)
     {
      double score=0.0;
   ...
   static double ComputeFinalRankConfidence(ISSX_EA1_SymbolState m,ISSX_EA2_SymbolState h,ISSX_EA3_SymbolSelection s,ISSX_EA5_OptionalIntelligence opt,const bool has_opt,const int contradiction_penalty_steps)
     {
   ...
   static void BuildHistoryCompactStrings(ISSX_EA2_SymbolState h,string &provenance_out,string &judgment_out)
     {
   ...
   static void SeedContextState(ISSX_EA5_ContextState &ctx,ISSX_EA2_SymbolState h,ISSX_EA3_SymbolSelection s)
     {
   ...
   static void BuildIntegrityTable(ISSX_EA5_IntegrityTable &it,ISSX_EA1_SymbolState m,ISSX_EA2_SymbolState h,ISSX_EA3_SymbolSelection s,ISSX_EA5_OptionalIntelligence opt,const bool has_opt)
     {
      it.Reset();
   ...
   static void BuildComparisonContract(ISSX_EA5_ComparisonContract &cc,ISSX_EA2_SymbolState h,ISSX_EA3_SymbolSelection s,ISSX_EA5_OptionalIntelligence opt,const bool has_opt)
     {
      cc.Reset();
   ...
   static int ContradictionPenaltySteps(ISSX_EA1_SymbolState m,ISSX_EA2_SymbolState h,ISSX_EA3_SymbolSelection s,ISSX_EA5_OptionalIntelligence opt,const bool has_opt,string &flags_out,ISSX_ContradictionSeverity &sev_out,string &class_counts_out,string &highest_blocking_class_out)
     {
      int steps=0;
      flags_out="";
   ...
   static string IntegrityBlockJson(ISSX_EA5_IntegrityBlock b)
     {
   ...
   static void PopulateWinnerFreshnessSurface(ISSX_EA5_WinnerFreshnessSurface &fs,ISSX_EA5_State state,ISSX_EA1_SymbolState m,ISSX_EA2_State ea2,const bool has_opt,ISSX_EA5_OptionalIntelligence opt)
     {
      fs.Reset();
   ...
   static void PopulateWinnerRegimeBlock(ISSX_EA5_WinnerRegimeBlock &rb,ISSX_EA1_SymbolState m,ISSX_EA2_SymbolState h,ISSX_EA5_OptionalIntelligence opt,const bool has_opt)
     {
      rb.Reset();
      ...
      rb.session_phase_class=SessionPhaseToString(m.validated_runtime_truth.session_phase);
   ...
   static void PopulateWinnerExplanationBlock(ISSX_EA5_WinnerExplanationBlock &eb,ISSX_EA3_SymbolSelection s,ISSX_EA2_SymbolState h,ISSX_EA5_OptionalIntelligence opt,const bool has_opt)
     {
      eb.Reset();
...
public:
   ...
   static void SetCompactOhlcPack(ISSX_EA5_State &state,const string symbol_norm,ISSX_EA5_CompactOhlcPack pack)
     {
