...
bool ASC_Conditions_Load(const string symbol, ASC_SymbolRecord &record)
{
   ...
   if(StringLen(symbol) == 0)
   {
      ...
      ASC_Logger_Log("ERROR","CONDITIONS","ASC_Conditions_Load","symbol is empty");
      return false;
   }
   ...
   ASC_Logger_Log("INFO","CONDITIONS","ASC_Conditions_Load",
                  "symbol=" + symbol +
                  " specs_readable=" + (record.ConditionsTruth.SpecsReadable ? "true" : "false") +
                  " integrity=" + record.ConditionsTruth.SpecIntegrityStatus +
                  " economics=" + record.ConditionsTruth.EconomicsTrust +
                  " reason=" + record.ConditionsTruth.SpecsReason);
