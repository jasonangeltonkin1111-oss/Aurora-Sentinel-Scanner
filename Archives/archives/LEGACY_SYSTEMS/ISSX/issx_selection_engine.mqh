...
#define ISSX_SELECTION_ENGINE_MODULE_VERSION "1.7.2"
   ...
   static void InheritUpstreamContext(ISSX_EA3_State &state,ISSX_EA1_State &ea1,ISSX_EA2_State &ea2)
     {
      ...
      state.fingerprint_algorithm_version=ea1.fingerprint_algorithm_version;
      ...
      for(int i=0;i<ArraySize(ea1.symbols);i++)
        {
         ...
         if(ea1.symbols[i].changed_this_cycle || ea2.symbols[hidx].changed_since_last_publish)
           {
